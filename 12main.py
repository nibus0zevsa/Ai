...
tema = 1                  #какой цифре обучаем, допустим 5
...
# если генератор выдал случайное число j, равное 5
            ...
            if r:                       # если сумматор сказал Нет (c not значит Да это пятерка), и j=5. Не ошибся
                increase(nums[j])        # Поощряем сеть (величиваем значение весов)
